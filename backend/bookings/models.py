...
class GolfCourse(models.Model):
    LOGIC_CHOICES = [
        ...
        ('cps', 'CPS Golf (Capital Hills)'),
        ('cps_old_post', 'CPS Golf (Old Post)'),
    ...
    advance_booking_days = models.IntegerField(default=7, help_text="Number of days in advance this course allows booking")
